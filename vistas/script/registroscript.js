...
function registroExitoso()
{
	...
	$('#mensaje-container').show().addClass("registro-bien");	
	//$("#pswd_info").show();
	$('#mensajeregex').show().addClass("registro-elementos");
}
function errorDatos()
{
	alert("El usuario y/o email que estás tratando de ingresar ya están registrados");
}