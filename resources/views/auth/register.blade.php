...
<div style="padding: 200px 0;background-image: url('http://www.clinicallabconsulting.com/wp-content/uploads/1.jpg'); color: white;background-size: cover;background-position: center;position: relative;min-height: calc( 100% - 60px );margin-top: -40px;">
